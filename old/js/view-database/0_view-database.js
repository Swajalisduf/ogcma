...
class Database {
	//Gets the sorted information from the server.
	getEntriesBySerial(e){
		...
		//Gets the sorted data from getEntriesBySerial.php and displays it in the .sum_body
...
class Functions {
	...
	//Adds a click event to the .sort element
